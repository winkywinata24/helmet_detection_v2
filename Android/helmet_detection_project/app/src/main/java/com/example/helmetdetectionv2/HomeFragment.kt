...
class HomeFragment : Fragment(), WebSocketEventListener {
    ...
    private lateinit var txtNoHelmToday: TextView
    private lateinit var txtNoStrapToday: TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtNoHelmToday = view.findViewById(R.id.txtNoHelmToday)
        txtNoStrapToday = view.findViewById(R.id.txtNoStrapToday)
        ...
        RetrofitClient.instance.getLog().enqueue(object : Callback<LogResponse> {
            override fun onResponse(call: Call<LogResponse>, response: Response<LogResponse>) {
                if (response.isSuccessful) {
                    ...
                    txtNoHelmToday.text = data.totalHelmToday.toString()
                    txtNoStrapToday.text = data.totalStrapToday.toString()
                }
            }
